...
namespace Microsoft.Band.Sensors
{
  internal class BandSensorSampleDeserializer
  {
    ...
    {
      this.GetSerializeByteCount = getSerializeByteCount;
      this.DeserializeFromBand = deserializeFromBand;
    }
    ...
    internal static BandSensorSampleDeserializer[] InitDeserializerTable()
    {
      ...
      BandSensorSampleDeserializer sampleDeserializer1 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandAccelerometerReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandAccelerometerReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer2 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandGyroscopeReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandGyroscopeReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer3 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandDistanceReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandDistanceReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer4 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandPedometerReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandPedometerReading.DeserializeFromBand));
      sampleDeserializerArray[19] = sampleDeserializer4;
      sampleDeserializerArray[109] = sampleDeserializer4;
      BandSensorSampleDeserializer sampleDeserializer5 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandCaloriesReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandCaloriesReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer6 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandUVReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandUVReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer7 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandGsrReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandGsrReading.DeserializeFromBand));
      ...
      BandSensorSampleDeserializer sampleDeserializer8 = new BandSensorSampleDeserializer(new Func<RemoteSubscriptionSampleHeader, int>(BandAltimeterReading.GetSerializedByteCount), new Func<ICargoReader, RemoteSubscriptionSampleHeader, DateTimeOffset, BandSensorReadingBase>(BandAltimeterReading.DeserializeFromBand));
